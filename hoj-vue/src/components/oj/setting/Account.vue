...
export default {
  data() {
    ...
    return {
      ...
      imgs:[
        require('@/assets/imgs/val1.jpg'),
        require('@/assets/imgs/val2.jpg'),
        require('@/assets/imgs/val3.jpg'),
        require('@/assets/imgs/val4.jpg'),
        require('@/assets/imgs/val5.jpg'),
        require('@/assets/imgs/val6.jpg'),
        require('@/assets/imgs/val7.jpg')
