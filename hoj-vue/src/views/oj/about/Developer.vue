  ...
  <div>
    <div class="intr-center">
      <paper-card type="server">
        <h1 class="text-darken">SMUOJ</h1>
        <h1>
          <a href="https://github.com/PHarr-mx/smuoj-vue" target="_blank"
            >Southwest Minzu University Online Judge</a
          >
        </h1>
        <p :style="{ fontWeight: 'bold' }">
          PHarr
          <a href="https://github.com/PHarr-mx" class="icon" target="_blank"
